...
func (f *fakeRuntime) Exec(containerID string, cmd []string, user *runtimeapi.User, stdin io.Reader, stdout, stderr io.WriteCloser, tty bool, resize <-chan remotecommand.TerminalSize) error {
